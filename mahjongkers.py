...
class Bamonker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/bamonker.jpg"
...
class Donker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/donker.jpg"
...
class Chonker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/chonker.jpg"
...
class Dragonker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/dragonker.jpg"
...
class Winker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/winker.jpg"
...
class Sequencker(Mahjongker):
    ...
    priority = 4 
    cost = 2
    img_src = "img/jongker/sequencker.jpg"
...
class MahMahMahjonker(Mahjongker):
    ...
    priority = 4 
    cost = 2
    img_src = "img/jongker/mahmahmahjonker.jpg"
...
class Milwaunker(Mahjongker):
    ...
    priority = 4 
    cost = 2
    img_src = "img/jongker/milwaunker.jpg"
...
class Kohlker(Mahjongker):
    ...
    priority = 4 
    cost = 2
    img_src = "img/jongker/kohlker.jpg"
...
class Windker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/windker.jpg"
...
class Draker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/draker.jpg"
...
class Evenker(Mahjongker):
    ...
    priority = 1 
    cost = 2
    img_src = "img/jongker/evenker.jpg"
...
class Oddker(Mahjongker):
    ...
    priority = 1 
    cost = 2
    img_src = "img/jongker/oddker.jpg"
...
class AYCker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/aycker.jpg"
    point_value = 0
...
class Pingker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/pingker.jpg"
    point_value = 0
...
class KingKongker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/kingkongker.jpg"
    point_value = 0
...
class Gapker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/gapker.jpg"
...
class DEIker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/deiker.jpg"
...
class Bourdainker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/bourdainker.jpg"
...
class Dollker(Mahjongker):
    ...
    priority = 5 
    cost = 2
    img_src = "img/jongker/dollker.jpg"
...
class Yenker(Mahjongker):
    ...
    priority = 5 
    cost = 2
    img_src = "img/jongker/yenker.jpg"
...
class Falchionker(Mahjongker):
    ...
    priority = 5 
    cost = 2
    img_src = "img/jongker/falchionker.jpg"
...
class Neenjaker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/neenjaker.jpg"
...
class Gayker(Mahjongker):
    ...
    priority = 5 
    cost = 2
    img_src = "img/jongker/gayker.jpg"
...
class Bumungker(Mahjongker):
    ...
    priority = 4 
    cost = 2
    img_src = "img/jongker/bumungker.jpg"
...
class Dungker(Mahjongker):
    ...
    priority = 4 
    cost = 2
    img_src = "img/jongker/dungker.jpg"
...
class Chungker(Mahjongker):
    ...
    priority = 4 
    cost = 2
    img_src = "img/jongker/chungker.jpg"
...
class Bimingker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/bimingker.jpg"
...
class Dingker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/dingker.jpg"
...
class Chingker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/chingker.jpg"
...
class Hoardker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/hoardker.jpg"
...
class Meldker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/meldker.jpg"
    point_value = 0
...
class Snakeker(Mahjongker):
    ...
    priority = 3 
    cost = 2
    img_src = "img/jongker/snakeker.jpg"
...
class Seeker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/seeker.jpg"
...
class LeeSinker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/leesinker.jpg"
    active = False
...
class SeeingDoubker(Mahjongker):
    ...
    priority = 3 
    cost = 2
    img_src = "img/jongker/seeingdoubker.jpg"
...
class Seequenker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/seequenker.jpg"
...
class Highker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/highker.jpg"
...
class Lowker(Mahjongker):
    ...
    priority = 2 
    cost = 2
    img_src = "img/jongker/lowker.jpg"
...
class Rainbowker(Mahjongker):
    ...
    priority = 2 
    cost = 5
    img_src = "img/jongker/rainbowker.jpg"
...
class Raindraker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/raindraker.jpg"
...
class Magellker(Mahjongker):
    ...
    priority = 5 
    cost = 5
    img_src = "img/jongker/magellker.jpg"
...
class Salarymanker(Mahjongker):
    ...
    priority = 5 
    cost = 2
    img_src = "img/jongker/salarymanker.jpg"
...
class MealTicker(Mahjongker):
    ...
    priority = 5 
    cost = 2
    img_src = "img/jongker/mealticker.jpg"
...
class WenGeker(Mahjongker):
    ...
    priority = 5 
    cost = 2
    img_src = "img/jongker/wengeker.jpg"
...
class Fourker(Mahjongker):
    ...
    priority = 5 
    cost = 2
    img_src = "img/jongker/fourker.jpg"
...
class DOWker(Mahjongker):
    ...
    priority = 5 
    cost = 2
    img_src = "img/jongker/dowker.jpg"
...
class Comebacker(Mahjongker):
    ...
    priority = 5 
    cost = 2
    img_src = "img/jongker/comebacker.jpg"
...
class Underdoker(Mahjongker):
    ...
    priority = 5 
    cost = 2
    img_src = "img/jongker/underdoker.jpg"
...
class Compensaker(Mahjongker):
    ...
    priority = 5 
    cost = 8
    img_src = "img/jongker/compensaker.jpg"
...
class Gronkowsker(Mahjongker):
    ...
    priority = 5 
    cost = 8
    img_src = "img/jongker/gronkowsker.jpg"
...
class Dumpsker(Mahjongker):
    ...
    priority = 5 
    cost = 8
    img_src = "img/jongker/dumpsker.jpg"
...
class Copycatker(Mahjongker):
    ...
    priority = 5 
    cost = 8
    img_src = "img/jongker/copycatker.jpg"
...
class Boomerangker(Mahjongker):
    ...
    priority = 5 
    cost = 8
    img_src = "img/jongker/boomerangker.jpg"
...
class Doraker(Mahjongker):
    ...
    priority = 1 
    cost = 2
    img_src = "img/jongker/doraker.jpg"
    selected_tile = []
...
class AllforOneker(Mahjongker):
    ...
    priority = 5 
    cost = 8
    img_src = "img/jongker/allforoneker.jpg"
...
class OneforAllker(Mahjongker):
    ...
    priority = 5 
    cost = 8
    img_src = "img/jongker/oneforallker.jpg"
...
class Pickgker(Mahjongker):
    ...
    priority = 5 
    cost = 8
    img_src = "img/jongker/pickgker.jpg"
...
class Straightker(Mahjongker):
    ...
    priority = 4 
    cost = 2
    img_src = "img/jongker/straightker.jpg"
...
all_mahjongkers_dict["windker"] = Draker()
